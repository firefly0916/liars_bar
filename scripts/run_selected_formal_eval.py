...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Optional maximum number of checkpoint tags to load from selection JSON when explicit tags are absent.",
    )
    ...
    parser.add_argument(
        ...
        default=os.environ.get("LOCAL_LLM_MODEL_PATH", ""),
        help="Optional local filesystem path for the Task M base model.",
    )
...
def main() -> int:
    ...
    for entry in plan["entries"]:
        ...
        if args.local_llm_model_path:
            llm_env["LOCAL_LLM_MODEL_PATH"] = args.local_llm_model_path
