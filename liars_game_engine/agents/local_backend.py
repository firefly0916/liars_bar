...
def _resolve_local_model_path(model_path: str | None = None) -> str | None:
    resolved = model_path or os.environ.get("LOCAL_LLM_MODEL_PATH")
    if resolved is None:
        return None
    text = str(resolved).strip()
    return text or None
...
def _load_model_bundle(
    ...
    resolved_model_path = _resolve_local_model_path(model_path) or model_name
